<template>
    <footer class="footer">
      <div class="container footer-content">
        <div class="copyright">
          &copy; {{ currentYear }} Timely - Paul BRUSON - Mathieu CLAIR
        </div>
        
        <div class="footer-links">
          <a href="https://github.com/Dr-J-Watson/Timely" target="_blank" class="github-link" title="Voir le code source sur GitHub">
